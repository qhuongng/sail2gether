export const Play = (
    <svg
        className="w-8 h-8 shrink-0 stroke-current"
...
export const Mute = (
    <svg
        className="w-7 h-7 shrink-0 stroke-current"
        xmlns="http://www.w3.org/2000/svg"
        fill="none"
        viewBox="0 0 24 24"
    >
...
export const VolumeUp = (
    <svg
        ...
        viewBox="0 0 24 24"
    >
        <path strokeLinecap="square" strokeLinejoin="miter" strokeWidth="2" d="M5 12h14m-7 7V5" />
    </svg>
);
...
export const VolumeDown = (
    <svg
        ...
        viewBox="0 0 24 24"
    >
        <path strokeLinecap="square" strokeLinejoin="miter" strokeWidth="2" d="M5 12h14" />
    </svg>
);
